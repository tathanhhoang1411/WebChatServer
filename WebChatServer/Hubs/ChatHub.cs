...
namespace WebChatServer.Hubs
{
    public class ChatHub:Hub
    {
        ...
        //This method send notification to all clients
        //if clients have communicate, it will call Sendmessage() method
        //if clients have to receive notification from server, it will use ReceiveMessage() method 
        public async Task SendMessage(string user, string message)
        {
            await Clients.All.SendAsync("ReceiveMessage", user, message);
        }
        //everyone join chat group
